...
inputfield.onsubmit = function (e) {
  ...
  action.innerHTML = `${field.value} <img src ='images/delete.png' class='cross'> <img src ='images/pencil.png' class='rename'>`;
  let content = document.querySelector(".maincontent");
  content.append(action);
  ...
  rename.forEach(function (item) {
    item.onclick = function () {
      ...
      renamebutton.onclick = function (e) {
        ...
        item.closest("div").innerHTML =
          renameinput.value +
          "<img src ='images/delete.png' class='cross'> <img src ='images/pencil.png' class='rename'>";
        backmodal.className = "renameOff";
        renameform.className = "renameformOff";
        renameinput.className = "renameinputOff";
        renamebutton.className = "renamebuttonOff";
...
function setsettingsOn() {
  ...
  if (
    (document.querySelector(".done") || document.querySelector(".actions")) &&
    document.querySelector(".settingsOff")
  ) {
    settings.className = "settingsOn";
  } else if (
    !(document.querySelector(".done") || document.querySelector(".actions")) &&
    document.querySelector(".settingsOn")
  ) {
...
function itemsleftrefresh() {
  if (document.querySelector(".settingsOn")) {
    ...
    let actdone = document.querySelectorAll(".done");
    let sumitem = undone.length + actdone.length;
    itemsleft.innerText = `${actdone.length}  /  ${sumitem} `;
  }
}
